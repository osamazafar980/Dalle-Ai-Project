  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      try{
        ...
        const response = await fetch('https://dalle-ai-nhqv.onrender.com/api/v1/post',{
          method: 'POST',
          headers: {
  ...
  const generateImage = async () => {
    if(form.prompt){
      try{
        ...
        const response =  await fetch('https://dalle-ai-nhqv.onrender.com/api/v1/dalle',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>
          Create stunning images generated by DALE-AI
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'> To Share it with the community.</p>
            <button
              type='submit'
